...
v=J.S(J.a9(w,a))+"px"
x.top=v}},
fR:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,b0,b1,b2,b3,b4,b5,b6,b7,b8,b9,c0,c1,c2,c3,c4,c5,c6,c7,c8,c9,d0,d1,d2,d3,d4,d5,d6,d7,d8,d9,e0,e1,e2,e3,e4,e5,e6,e7
z=$.u
z.toString
...
r=C.d.h(0)+"px"
s.marginTop=r
c7=u.querySelector("#image4")
s=c7.style
r=C.a.h(c0)+"px"
s.width=r
s=c7.style
c0=C.a.h((c2-c0/1251*860)*0.5)+"px"
s.top=c0
s=c7.style
r=C.a.h(c5*0.5)+"px"
s.left=r
c8=u.querySelector("#text4")
s=c8.style
r=C.e.h(a4)+"px"
s.top=r
s=c8.style
...
r=C.a.h(a0)+"px"
s.lineHeight=r
e1=u.querySelector("#youtube_link_1")
s=e1.style
r=C.a.h(a)+"px"
s.fontSize=r
s=e1.style
...
r=C.a.h(r*0.4)+"px"
s.left=r
e2=u.querySelector("#youtube_link_2")
s=e2.style
r=C.a.h(a)+"px"
s.fontSize=r
s=e2.style
...
r=C.a.h(y)+"px"
s.top=r
e5=u.querySelector("#mail")
s=J.E(e5)
r=s.gO(e5)
W.x(r.a,r.b,new F.fY(e5),!1,H.r(r,0))
s=s.gP(e5)
W.x(s.a,s.b,new F.fZ(e5),!1,H.r(s,0))
s=e5.style
r=C.a.h(e3)+"px"
s.height=r
s=e5.style
...
k=C.a.h(r)+"px"
s.top=k
e6=u.querySelector("#facebook")
s=J.E(e6)
s.sv(e6,"./images/facebook_white.png")
k=s.gO(e6)
W.x(k.a,k.b,new F.h_(e6),!1,H.r(k,0))
s=s.gP(e6)
W.x(s.a,s.b,new F.h0(e6),!1,H.r(s,0))
s=e6.style
k=C.a.h(e3)+"px"
s.height=k
s=e6.style
...
r=C.a.h(r)+"px"
s.top=r
$.aE=d+e+a2+a1+0+a8+b6+b5+0+c2+d0+c9+d6+d6+d*0.1
...
s=u*0.3
F.fH(["./images/background1.png","./images/background2.png","./images/background3.png"],[e7,e7,e7],[u*0.4,s,s])},
ho:{"^":"f:0;",
$1:function(a){F.db()}},
hp:{"^":"f:0;",
